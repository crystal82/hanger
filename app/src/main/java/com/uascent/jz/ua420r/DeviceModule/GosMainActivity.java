...
import com.uascent.jz.ua420r.CommonModule.NoScrollViewPager;
...
import com.uascent.jz.ua420r.sharingdevice.messageCenterActivity;
import com.uascent.jz.ua420r.utils.MyWebStateReceive;
...
public class GosMainActivity extends GosDeviceModuleBaseActivity {
    ...
    MyWebStateReceive myWebStateReceive;
    ...
    private void initPagerViewer() {
        ...
        img1.setBackgroundResource(R.drawable.menu_w);//
        img2.setBackgroundResource(R.drawable.message_g);
        img3.setBackgroundResource(R.drawable.person_g);

        tx1.setTextColor(getResources().getColor(R.color.white));//
        tx2.setTextColor(getResources().getColor(R.color.colorNormal));
        tx3.setTextColor(getResources().getColor(R.color.colorNormal));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_addDevice:
                if (!NetUtils.isWifiConnected(GosMainActivity.this)) {
        ...
        public void onClick(View v) {
            ...
            switch (index) {
                ...
                case 1:
                    ...
                    img1.setBackgroundResource(R.drawable.menu_g);
                    img2.setBackgroundResource(R.drawable.message_w);
                    img3.setBackgroundResource(R.drawable.person_g);

                    tx1.setTextColor(getResources().getColor(R.color.colorNormal));
                ...
                case 2:
                    ...
                    img1.setBackgroundResource(R.drawable.menu_g);
                    img2.setBackgroundResource(R.drawable.message_g);
                    img3.setBackgroundResource(R.drawable.person_w);
    ...
    public void exitBy2Click() {
        ...
        if (isExit == false) {
            ...
            if (!TextUtils.isEmpty(spf.getString("UserName", ""))
                ...
                if (getIntent().getBooleanExtra("ThreadLogin", false)) {
                    doubleClick = (String) getText(R.string.doubleclick_logout);
                } else {
