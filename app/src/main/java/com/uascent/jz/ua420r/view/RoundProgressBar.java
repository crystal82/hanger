...
public class RoundProgressBar extends View {
	...
	public RoundProgressBar(Context context, AttributeSet attrs, int defStyle) {
		...
		roundColor = mTypedArray.getColor(R.styleable.RoundProgressBar_roundColor, R.color.hint);
		roundProgressColor = mTypedArray.getColor(R.styleable.RoundProgressBar_roundProgressColor, R.color.primary);
		textColor = mTypedArray.getColor(R.styleable.RoundProgressBar_textColor,  R.color.primary);
