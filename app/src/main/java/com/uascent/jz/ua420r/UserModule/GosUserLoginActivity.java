package com.uascent.jz.ua420r.UserModule;
...
import com.uascent.jz.ua420r.GosApplication;
...
import com.uascent.jz.ua420r.ThirdAccountModule.BaseUiListener;
import com.uascent.jz.ua420r.view.DotView;
...
public class GosUserLoginActivity extends GosUserModuleBaseActivity implements OnClickListener {
    ...
    private void initView() {
        uy_Home = (TextView) findViewById(R.id.uy_home);
    ...
    protected void didUserLogin(GizWifiErrorCode result, String uid, String token) {
        ...
        Log.i("Apptest", "Apptest---:" + GosDeviceListActivity.loginStatus + "\t" + "User  " + GosDeviceListActivity.sAutoLogin);
        ...
        if (GizWifiErrorCode.GIZ_SDK_SUCCESS != result) {// 登录失败
            ...
            intent = new Intent(GosUserLoginActivity.this, GosMainActivity.class);
            intent.putExtra("ThreadLogin", true);
            GosDeviceListActivity.sAutoLogin = false;
            GosDeviceListActivity.mThreadLogin = true;
            startActivity(intent);
            finish();
        }
    }
