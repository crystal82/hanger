...
public class GosDeviceControlActivity extends GosControlModuleBaseActivity
    ...
    private void initView() {
        ...
        findViewById(R.id.time).setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(GosDeviceControlActivity.this, TimerSettingActivity.class);
    ...
    public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
       ...
       // hideKeyBoard(ll_Dev,GosDeviceControlActivity.this);
        return false;
    ...
    protected void updateUI() {
        ...
        sw_bool_switch.setChecked(mSwitch);
    ...
    private void toastDeviceNoReadyAndExit() {
        Toast.makeText(this,     getString(R.string.equipment_no_response)
                , Toast.LENGTH_SHORT).show();
        finish();
    }

    private void toastDeviceDisconnectAndExit() {
        Toast.makeText(GosDeviceControlActivity.this, getString(R.string.disconnect), Toast.LENGTH_SHORT).show();
        finish();
    }
    ...
    protected void didGetHardwareInfo(GizWifiErrorCode result, GizWifiDevice device,
        ...
        if (GizWifiErrorCode.GIZ_SDK_SUCCESS != result) {
            myToast(getString(R.string.hardware_information_error)+ result.name());
        } else {
