...
public class HangerControlActivity extends GosControlModuleBaseActivity implements ViewPager.OnPageChangeListener {
    ...
    public void showDilaog() {
        mCustomWaitDialog2.show();
        mHandler.postDelayed(waitRunnable, 3 * 1000);
    }
    ...
    private void ShosErrorInfo() {
        if (mHangerBean.otherBean.overweightPro) {
            Toast.makeText(HangerControlActivity.this, "超重啦！", Toast.LENGTH_SHORT).show();
        } else if (mHangerBean.otherBean.blockPro) {
            Toast.makeText(HangerControlActivity.this, "有障碍物啦！", Toast.LENGTH_SHORT).show();
        }
    }
}
