...
public class ControlFragment extends BaseFragment implements View.OnClickListener {
    ...
    public void initView() {
        if (mHangerBean != null) {
            ...
            mIvControlTz.setSelected((mHangerBean.buttonState & 3) == 0);
            mIvControlSs.setSelected((mHangerBean.buttonState & 3) == 1);
            mIvControlXj.setSelected((mHangerBean.buttonState & 3) == 2);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.iv_control_gj:
                ...
                mCloneHangerBean.heightState = -16;
